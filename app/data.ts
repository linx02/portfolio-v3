...
export const BLOG_POSTS: BlogPost[] = [
  {
    title: 'Mina lösningar för Advent of Code 2025 - Med visualiseringar',
    description:
      'En genomgång av mina lösningar för Advent of Code 2025, inklusive interaktiva visualiseringar av algoritmerna.',
    link: '/blog/advent-of-code-2025',
    uid: 'blog-1',
  },
]
